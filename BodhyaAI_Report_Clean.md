...
|------|--------|-----------------|--------|
| 1 | Login as mentor | Dashboard loads | ✓ Pass |
| 2 | Navigate to Students page | Student list displays | ✓ Pass |
| 3 | Filter by "High Risk" | Only high-risk students shown | ✓ Pass |
| 4 | Click on student | Profile page loads | ✓ Pass |
| 5 | View SHAP explanation | Feature importance chart displays | ✓ Pass |

**Test Case 2: Chat with AI Mentor**

| Step | Action | Expected Result | Status |
|------|--------|-----------------|--------|
| 1 | Open student profile | Risk and cognitive data visible | ✓ Pass |
| 2 | Open chat interface | Chat window appears | ✓ Pass |
| 3 | Type: "How can I help this student?" | Input accepted | ✓ Pass |
| 4 | Click Send | API call initiated, loading indicator shows | ✓ Pass |
| 5 | Wait for response | AI recommendation appears within 5s | ✓ Pass |
| 6 | Ask follow-up question | Context-aware response received | ✓ Pass |
...
- ✓ "Dashboard is intuitive and provides quick overview"
- ✓ "SHAP visualizations help me understand why a student is at risk"
- ✗ "Chat interface sometimes gives generic responses"
- ✗ "Would like export functionality for reports"

**Functionality (Average Rating: 4.5/5)**
- ✓ "Risk predictions align with my observations of students"
- ✓ "Cognitive profiling adds valuable psychological context"
- ✓ "Explainability features build trust in AI recommendations"
- ✗ "Batch processing for entire class would save time"

**Performance (Average Rating: 3.8/5)**
- ✓ "System is responsive for individual student lookups"
- ✗ "Chat responses occasionally take too long (>5s)"
- ✗ "Initial dashboard load is slow with many students"
...
- ✓ "AI recommendations are surprisingly nuanced and consider both academic and psychological factors"
- ✓ "Responses feel personalized rather than template-based"
- ✗ "Occasionally too generic when student context is limited"
- ✗ "Would benefit from citing specific campus resources (tutoring center, counseling)"
...
|-------|-------|----------|----------|----------------|-----------|
| Rodriguez et al. (2025) | XGBoost | 69.02% | 0.69 | ✗ | ✗ |
| Anderson et al. (2025) | Ensemble+SHAP | 77.40% | - | ✓ | ✗ |
| Patel et al. (2025) | Ensemble+SMOTE | 84.30% | 0.84 | ✗ | ✗ |
| **BodhyaAI (This Work)** | **XGBoost+SHAP+LIME** | **95.23%** | **0.95** | **✓** | **✓** |
...
✓ **Objective 1:** Implemented interpretable XGBoost and Random Forest classifiers exceeding 90% CV accuracy target

✓ **Objective 2:** Integrated SHAP and LIME with real-time visualization generation accessible to non-technical mentors

✓ **Objective 3:** Developed BFI-44 cognitive profiling service correlating OCEAN traits with academic performance

✓ **Objective 4:** Deployed RAG-lite framework with Google Gemini API producing contextually grounded mentoring recommendations

✓ **Objective 5:** Created production-ready microservices architecture with Node.js backend and React frontend

✓ **Objective 6:** Conducted rigorous 5-fold cross-validation and mentor user acceptance testing

✓ **Objective 7:** Implemented bias monitoring, data privacy measures, and human oversight mechanisms

✓ **Objective 8:** Documented findings in IEEE conference paper format and comprehensive project report
